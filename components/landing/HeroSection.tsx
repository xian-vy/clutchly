    ...
    <section className="relative !overflow-hidden flex items-center">
      ...
      <div className="max-w-full relative z-10 flex flex-col md:flex-row items-center w-full justify-between gap-12 py-12">
        ...
        <div className="flex-1 max-w-3xl w-full text-left">
          ...
          {/* Headline */}
          <motion.h1 
            className="font-bold tracking-tighter text-4xl md:text-6xl 2xl:text-[4rem] text-[#333] dark:text-foreground mb-4 text-left"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.5 }}
          >
          ...
          {/* Supporting text */}
          <motion.p 
            className="mt-6 text-base xl:text-lg 3xl:!text-xl text-muted-foreground max-w-lg xl:max-w-2xl mb-8 text-left"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex-1 flex justify-end items-center w-full relative h-[400px] md:h-[500px] xl:h-[550px] 3xl:!h-[700px] 3xl:mt-8">
          <div className="relative w-[350px] md:w-[400px] xl:w-[700px] 3xl:!w-[900px] h-full border-y border-l overflow-hidden rounded-l-xl shadow-2xl shadow-primary/30 dark:shadow-primary/15">
            <Image 
