...
const TopNavigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f0fdf4]/20 dark:bg-gray-900/20 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50">
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              />
              <span className="text-base md:text-lg 2xl:text-xl font-semibold text-foreground/90">
                Clutchly
              </span>
            </Link>
          </div>
