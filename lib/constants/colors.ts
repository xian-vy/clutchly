export const STATUS_COLORS = {
  ...
  deceased: 'bg-[#444] dark:bg-[#222] text-white',
...
export const PAYMENT_COLORS = {
  ...
  credit_card:'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-400',
  paypal: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400',
  other: 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400',
} as const;

export const SHEDDING_COLORS = {
  full :  'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  partial: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400', 
  retained: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400',
  unknown: 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400',
} as const;

export const FEEDING_STATUS_COLORS = {
  fed: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  unfed: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400',
} as const; 


export const CARELEVEL_COLORS = {
