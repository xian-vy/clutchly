  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      ...
      <main className="container py-12 sm:py-16 px-4 mx-auto">
        ...
        {/* Features Grid */}
        <div className="grid gap-3 sm:gap-4 lg:gap-5 xl:gap-6 sm:grid-cols-2  lg:grid-cols-3 3xl:!grid-cols-4 w-10/12 lg:max-w-screen-lg 3xl:!max-w-screen-xl mx-auto">
